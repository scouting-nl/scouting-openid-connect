...
function scouting_oidc_shortcode_submenu_page() {
    add_submenu_page(
        ...
        'scouting_oidc_shortcode_page_callback', // Callback function
        2                                        // Menu position
    );
}

// Callback to render support page content
function scouting_oidc_shortcode_page_callback() {
    ?>
    <div class="wrap">
 ...
 */
function enqueue_live_shortcode_script() {
