...
class Settings_General {
	...
	public function scouting_oidc_settings_general(): void {
		...
		add_settings_section(
			...
			array( $this, 'scouting_oidc_settings_general_callback' ), // Callback to render section
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_display_name_callback' ), // Callback to render field
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_birthdate_callback' ),      // Callback to render field
			'scouting-openid-connect-settings',                                // Page slug
			'scouting_oidc_general_settings'                                   // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_gender_callback' ),      // Callback to render field
			'scouting-openid-connect-settings',                             // Page slug
			'scouting_oidc_general_settings'                                // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_phone_callback' ),             // Callback to render field
			'scouting-openid-connect-settings',                                   // Page slug
			'scouting_oidc_general_settings'                                      // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_address_callback' ),      // Callback to render field
			'scouting-openid-connect-settings',                              // Page slug
			'scouting_oidc_general_settings'                                 // Section ID where the field should be added
		);
		...
		if ( class_exists( 'WooCommerce' ) ) {
			...
			add_settings_field(
				...
				array( $this, 'scouting_oidc_settings_general_woocommerce_sync_callback' ),              // Callback to render field
				'scouting-openid-connect-settings',                                               // Page slug
				'scouting_oidc_general_settings',                                                 // Section ID where the field should be added
				array(
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_user_auto_create_callback' ), // Callback to render field
			'scouting-openid-connect-settings',                                  // Page slug
			'scouting_oidc_general_settings'                                     // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_duplicate_email_callback' ), // Callback to render field
			'scouting-openid-connect-settings',                                 // Page slug
			'scouting_oidc_general_settings'                                    // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_user_redirect_callback' ), // Callback to render field
			'scouting-openid-connect-settings',                               // Page slug
			'scouting_oidc_general_settings'                                  // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_login_redirect_callback' ),          // Callback to render field
			'scouting-openid-connect-settings',                                         // Page slug
			'scouting_oidc_general_settings'                                            // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_custom_redirect_callback' ),               // Callback to render field
			'scouting-openid-connect-settings',                                               // Page slug
			'scouting_oidc_general_settings',                                                 // Section ID where the field should be added
			array(
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_debug_logging_callback' ),  // Callback to render field
			'scouting-openid-connect-settings',                                // Page slug
			'scouting_oidc_general_settings'                                   // Section ID where the field should be added
		);
		...
		add_settings_field(
			...
			array( $this, 'scouting_oidc_settings_general_log_retention_days_callback' ),   // Callback to render field
			'scouting-openid-connect-settings',                                       // Page slug
			'scouting_oidc_general_settings'                                          // Section ID where the field should be added
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_display_name_option' ), // Sanitize the input value as display name
			)
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_boolean_option' ), // Sanitize the input value as a boolean (0 or 1)
			)
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_duplicate_email_option' ), // Sanitize the input value for duplicate email handling
			)
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_login_redirect_option' ), // Sanitize the input value as login redirect
			)
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_custom_redirect_option' ), // Sanitize the input value as custom redirect
			)
		);
		...
		register_setting(
			...
			array(
				'sanitize_callback' => array( $this, 'scouting_oidc_sanitize_log_retention_days_option' ), // Sanitize retention days as bounded integer
			)
		);
