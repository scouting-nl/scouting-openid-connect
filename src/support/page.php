...
class Support
{
    ...
    public function scouting_oidc_support_page_callback() {
        ...
        <div class="wrap">
            ...
            <ol>
                <li><?php esc_html_e('Go to', 'scouting-openid-connect'); ?> <a href="https://login-staging.scouting.nl" target="_blank">login-staging.scouting.nl</a>, <?php esc_html_e('click on "Managed websites" and click on "Add OpenID Connect connection".', 'scouting-openid-connect'); ?></li>
