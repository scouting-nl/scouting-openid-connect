    ...
    public function scouting_oidc_support_page_callback() {
        ...
        <div class="wrap">
            ...
            <ol>
                ...
                <li><?php esc_html_e('Fill in the General Settings. Optional scopes: use "profile" for birthdate and gender, "phone" for phone number, and "address" for address information.', 'scouting-openid-connect'); ?></li>
